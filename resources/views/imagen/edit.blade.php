<!-- Modal -->
<div class="modal fade" id="edit{{ $imagen->id_imagen }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('imagen.update', $imagen->id_imagen) }}" method="POST"
                    ...
                    <div class="mb-3">
                        ...
                        <img src="{{ Str::startsWith($imagen->url_imagen, 'http') ? $imagen->url_imagen : asset($imagen->url_imagen) }}"
                            alt="Imagen actual" width="100" class="img-thumbnail">
                    </div>
