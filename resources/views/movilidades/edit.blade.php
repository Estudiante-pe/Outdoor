            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="empresa" id="empresa" value="{{ $movilidad->empresa }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="conductor" class="form-label">Conductor</label>
                        <input type="text" class="form-control" name="conductor" id="conductor" value="{{ $movilidad->conductor }}" required>
                    </div>
                    <div class="mb-3">
                        <label for="placa" class="form-label">placa</label>
                        <input type="text" class="form-control" name="placa" id="placa" value="{{ $movilidad->placa }}" required>
                    </div>
                    <div class="mb-3">
